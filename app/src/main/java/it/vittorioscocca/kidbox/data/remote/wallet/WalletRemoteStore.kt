...
data class WalletTicketRemoteDto(
    ...
    val arrivalLocationPlain: String?,
    val holderNameEnc: String?,
    val holderNamePlain: String?,
    val notesEnc: String?,
    val notesPlain: String?,
    val barcodeTextEnc: String?,
    val barcodeTextPlain: String?,
    val fileNameEnc: String?,
    val fileNamePlain: String?,
    val kindRaw: String?,
    val emitter: String?,
                    ...
                    if (err != null) {
                        ...
                        val changes = snap.documentChanges.mapNotNull { diff ->
                            ...
                            val dto = WalletTicketRemoteDto(
                                ...
                                arrivalLocationPlain = d["arrivalLocation"] as? String,
                                holderNameEnc = d["holderNameEnc"] as? String,
                                holderNamePlain = d["holderName"] as? String,
                                notesEnc = d["notesEnc"] as? String,
                                notesPlain = d["notes"] as? String,
                                barcodeTextEnc = d["barcodeTextEnc"] as? String,
                                barcodeTextPlain = d["barcodeText"] as? String,
                                fileNameEnc = d["fileNameEnc"] as? String,
                                fileNamePlain = d["fileName"] as? String,
