...
import it.vittorioscocca.kidbox.ui.screens.settings.family.FamilySettingsViewModel
    ...
    Column(
        ...
        Card(
            ...
            Row(
                ...
                Icon(Icons.Filled.QrCodeScanner, null, tint = Color(0xFF2E86FF), modifier = Modifier.size(22.dp))
